...
import { ArrowLeft, ArrowRight, IndianRupee, Smartphone, Quote } from 'lucide-react';
...
const testimonials = [
  ...
  {
    quote: 'Well trained staff. Overall a positive experience in selling my phone at Fundu.',
    name: 'Karan Sharma',
  ...
  {
    quote: 'Awesome doorstep service! Evaluation was fair and payout came within 5 minutes.',
    name: 'Neha Gupta',
    ...
    <section className="bg-[#0f1214] pt-12 text-white overflow-hidden">
      <div className="container-page">
        ...
        <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
          <h2 className="max-w-2xl font-display text-3xl font-extrabold leading-tight md:text-4xl">
            Trusted by 189.97 Lac + Happy Users and Major Brands since 2015
          </h2>
        ...
        <div className="relative mt-10 pb-12">
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {testimonials.slice(startIndex, startIndex + visibleCount).map((item) => (
              ...
              >
                <div>
                  <Quote className="h-10 w-10 text-[#4cd2c4] fill-[#4cd2c4]/20 rotate-180" />
                ...
                <div className="mt-6 flex items-center gap-3">
                  <img
                    src={item.avatar}
                    alt={item.name}
                    className="h-11 w-11 rounded-full object-cover border-2 border-brand-100"
                  />
                  <div>
